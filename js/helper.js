...
var HTMLmobile = '<li class="flex-item"><span class="orange-text">mobile</span> %data%</li>';
var HTMLemail = '<li class="flex-item"><span class="orange-text">email</span> %data%</li>';
var HTMLtwitter = '<li class="flex-item"><span class="orange-text">twitter</span> %data%</li>';
var HTMLgithub = '<li class="flex-item"><span class="orange-text">github</span> %data%</li>';
var HTMLblog = '<li class="flex-item"><span class="orange-text">blog</span> %data%</li>';
var HTMLlocation = '<li class="flex-item"><span class="orange-text">location</span> %data%</li>';

var HTMLbioPic = '<img src="%data%" class="biopic">';
var HTMLWelcomeMsg = '<span class="welcome-message">%data%</span>';

var HTMLskillsStart = '<h3 id="skillsH3">Skills at a Glance:</h3><ul id="skills" class="flex-box white-text"></ul>';
